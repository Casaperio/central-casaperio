...
import { Trash2, UserPlus, Shield, KeyRound, X, AlertTriangle, Check, Wrench, Users, UserCog, Camera, Image as ImageIcon, Box, Briefcase, CalendarRange, Gem, LayoutDashboard } from 'lucide-react';
           ...
           <tr key={user.id} className="hover:bg-gray-50 transition-colors">
            ...
            <td className="p-4 text-right">
             <div className="flex justify-end gap-2">
              ...
              {user.email !== currentUserEmail && user.email !== 'admin@casape.com' ? (
               <button
                type="button"
